...
let is_irrelevant infos lft c =
  ...
  try Retypeops.relevance_of_fterm env (info_relevances infos.cnv_inf) lft c == Sorts.Irrelevant with _ -> false

(* Conversion between  [lft1]term1 and [lft2]term2 *)
let rec ccnv cv_pb l2r infos lft1 lft2 term1 term2 cuniv =
  if is_irrelevant infos lft1 term1 && is_irrelevant infos lft2 term2
  then cuniv else eqappr cv_pb l2r infos (lft1, (term1,[])) (lft2, (term2,[])) cuniv
